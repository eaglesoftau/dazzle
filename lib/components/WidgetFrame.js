...
import { removeWidget, sortWidget, editWidget } from '../util';
...
class WidgetFrame extends Component {
  ...
  edit = () => {
    const { layout, rowIndex, columnIndex, widgetIndex, widgetData } = this.props;
    const newLayout = editWidget(layout, rowIndex, columnIndex, widgetIndex, widgetData);
    this.props.onEdit(newLayout, rowIndex, columnIndex, widgetIndex, widgetData);
  }
 }
